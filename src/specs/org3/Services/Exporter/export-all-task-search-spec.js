...
for (let i = 0; i < 1; i++) {
    describe('Exporter ', function () {
        ...
        it('1. Export All - Task Search Page - Excel', function () {
            ui.menu.click_Search__Tasks()
            ui.searchTasks.enter_task_title(equals, D.newTask)
                .click_Search()
                .click_button('Export')
        ...
        it('2. Export All - Task Search Page - CSV', function () {
            ui.menu.click_Search__Tasks()
            ui.searchTasks.enter_task_title(equals, D.newTask)
                .click_Search()
                .click_button('Export')
