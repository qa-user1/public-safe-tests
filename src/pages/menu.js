...
let
    ...
    add = e => sideMenu().contains('Add'),
    case_ = e => sideMenu().find('[href="#/case/add"]'),
    item = e => sideMenu().find('[href="#/item/add"]'),
    person = e => sideMenu().find('[href="#/person/add"]'),
